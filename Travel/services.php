...
-->
    ...
    <body>
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-2">
                            <div class="main-menu">
                                <ul class="visible-lg visible-md">
                                    ...
                                    <li class="active"><a href="services.php">Visit Info</a></li>
		...
		<div class="col-md-5 col-sm-6">
                        <h3 class="widget-title">Search Visit Info</h3>
                        <div class="contact-form">
                            <form name="contactform" id="contactform" action="services.php" method="post">
			<form  action="services.php" method="post">
		    <input type="text" name="search_name" placeholder="Search by Country Name"/>
			<tr>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7 col-sm-6 map-wrapper">
                        <h3 class="widget-title">Kate Visit Info</br></h3>
                           <?php
...
?>						
                        ...
                        <div class="contact-infos">
                            <ul>
                                ...
                                <li>Email: <a href="mailto:kate@gmail.com">kate@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
