                        ...
                        <div class="col-md-8 col-sm-6 col-xs-2">
                            <div class="main-menu">
                                <ul class="visible-lg visible-md">
                                    ...
                                    <li class="active"><a href="events.php">Visit Record</a></li>
									<li><a href="editrecord.php">Edit Record</a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5 col-sm-6">
                        <h3 class="widget-title">Add Visit Record</h3>
                        <div class="contact-form">			
      <form name="contactform" id="contactform" action="add.php" method="post">	
			...
			<tr>
				<td colspan="2" align="center">
                     <input type="hidden" value="insert" name="event" />				
